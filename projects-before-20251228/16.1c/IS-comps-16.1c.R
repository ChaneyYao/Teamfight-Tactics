...
url <- "https://api-hc.metatft.com/tft-comps-api/comps_stats?queue=1100&patch=current&days=1&rank=BRONZE,GOLD,IRON,PLATINUM,RANKUNKNOWN,SILVER&permit_filter_adjustment=true"
res <- GET(url)
